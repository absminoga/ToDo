...
getDate(){
  ...
  "July","August","September","October","November","December");
    let datePosition = document.querySelector('div.container_date');
    datePosition.innerText = (d.getDate()+ ", " + month[d.getMonth()] + ", " + d.getFullYear() + " " + d.getHours() + ":" +  d.getMinutes() + ":" + d.getSeconds());
}
}
